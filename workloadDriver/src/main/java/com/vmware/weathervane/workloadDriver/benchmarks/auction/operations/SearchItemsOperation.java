...
public class SearchItemsOperation extends AuctionOperation  {
   ...
   public SearchItemsOperation(User userState, Behavior behavior, Target target, StatsCollector statsCollector) {
...
//			System.out.println("NoOperation:execute: UserID = " + getUser().getId());
		...
		default:
			throw new RuntimeException("SearchItemsOperation: Unknown operation step "
